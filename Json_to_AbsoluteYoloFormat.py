...
###Faster RCNN
RESULT_PATH = "C:/Users/Sigurd/OneDriveMS/FYS-3741-MASTER/Tensorflow/workspace/inference_tools/"
...
RESULT_NAME = 'Labels/YOLOv4_results.json'
SAVE_PATH = 'objMet_Labels/yolov4_pred/'

### EfficientDet_d1
#RESULT_PATH = "C:/Users/sigur/OneDriveMS/FYS-3741-MASTER/Tensorflow/workspace/inference_tools/"
#RESULT_NAME = 'New_labels/EffDetD1_nms.json'
#SAVE_PATH = 'objMet_Labels/effDet_yolo_pred/'
...
class JsonWriter:
    ...
    def __call__(self):
        ...
        for index, image in enumerate(self.df['image_id']):
            sys.stdout.write('\r {}%'.format(round((index+1)/n_img * 100)))
            sys.stdout.write('\r {}{}%'.format(image, index))
